...
def find_re(p, m, g, keyPublicB):
    k = randint(1, p-2)
    print('k: ', k)
    r = find(g, k, p)
    e = find(keyPublicB, k, p) * m
    return r, e

r, e = find_re(p, m, g, keyPublicB)
print('r: ', r)
print('e: ', e)
m1 = (find(r, p-1-keyPrivateB, p) * e) % p
print('Сообщение, полученное абонентом B: ', m1)
if m == m1:
